%MATLAB Tutorial for Summer 2017 Research 
...
\begin{frame}{\texttt{bsxfun}}
	\vspace{-4ex}
	Supose that you have a row vector, \mcode{x}, and you want to make the matrix 
	\mcode{A = (a_ij) = (x_i^j)} for $j=0, \ldots, p$.  The function \mcode{bsxfun} does this 
	quickly:
	\vspace{-2ex}
...
\begin{frame}{Resources}
	...
	%Come to the \alert{Advanced \Matlab Tutorial} here at 9 AM, tomorrow, Tuesday, 
	%May 24.
